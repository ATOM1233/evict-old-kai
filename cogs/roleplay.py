...
class roleplay(commands.Cog):
    ...
    @commands.cooldown(1, 3, commands.BucketType.user)
    @commands.command(name="nutkick", help="roleplay", description="kick a user in the balls")
    ...
    @commands.cooldown(1, 3, commands.BucketType.user)
    @commands.command(name="fuck", help="roleplay", description="fuck a user", usage='[member]')
    ...
    @commands.cooldown(1, 3, commands.BucketType.user)
    @commands.command(name="threesome", help="roleplay", description="have a threesome", usage='[member] [member]')
