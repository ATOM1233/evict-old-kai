...
class donor(commands.Cog):
  ...
  @commands.command(description="revoke the hardban from an user", usage="[user]", brief="administrator")
  ...
  @commands.command(description="hardban a user from the server", usage="[user]", brief="administrator")
  @Permissions.has_permission(administrator=True)
  ...
  @Permissions.has_permission(administrator=True)
  @commands.command(description="check hardban list", brief='administrator')
  ...
  @commands.command(description="uwuify a person's messages", usage="[member]", brief="manage messages")
  ...
  @Permissions.has_permission(manage_messages=True)
  @commands.command(description="check uwulock list", brief='manage messages')
  ...
  @commands.command(description="remove everyone from uwulock", brief="server owner")
  ...
  @Permissions.server_owner()
  @commands.command(description="remove everyone from hardban", brief="server owner")
  ...
  @commands.command(aliases=['stfu'], description="delete a person's messages", usage="[member]", brief="manage messages")
  @Permissions.has_permission(manage_messages=True)
  ...
  @Permissions.server_owner()
  @commands.command(aliases=["stfureset"], description="remove everyone from uwulock", brief="server owner")
  ...
  @Permissions.has_permission(manage_messages=True)
  @commands.command(aliases=["stfulist"], description="check shutup list", brief='manage messages')
  async def shutuplist(self, ctx: commands.Context): 
          ...
          for result in results:
              ...
              if l == 10:
               messages.append(mes)
               number.append(discord.Embed(color=self.bot.color, title=f"stfu list [{len(results)}]", description=messages[i]))
               i+=1
               mes = ""
               l=0
  ...
  @commands.command(description="force nickname a user", usage="[member] [nickname]", aliases=["locknick", "fn"], brief="manage nicknames")
  ...
  @commands.command(aliases=["forcenickclear"], description="clear everyone's forcenickname", brief="administrator")
  @Permissions.has_permission(administrator=True)
  async def fnclear(self, ctx: commands.Context):
  ...
  @commands.command(description="purges an amount of messages sent by you", usage="[amount]")
  ...
  @commands.group(invoke_without_command=True, name="reskin", description="Reskin Settings")    
  async def reskin(self, ctx: commands.Context):
    return await ctx.create_pages()
  
  @reskin.command(name="enable", description="Reskin Enable", help="reskin", aliases=['on'])
  ...
  @reskin.command(name="disable", description="Reskin Disable", help="reskin", aliases=['off'])
  ...
  @reskin.command(name="avatar", description="Reskin Avatar", aliases=['av'], help="reskin")
